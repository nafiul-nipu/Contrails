    ...
    if(filter_params2){
        ...
        if (filter_params2['rho_eul_avg']) {
            data = data.filter(el => {
                ...
                var result = e.some(r => (filter_params2['rho_eul_avg'] >= r -0.05 ) && (filter_params2['rho_eul_avg'] <= r+ 0.05))
                return result
        ...
        if (filter_params2['p_eul_avg']) {
            data = data.filter(el => {
                ...
                var result = e.some(r => (filter_params2['p_eul_avg'] >= r - 10) && (filter_params2['p_eul_avg'] <= r+ 10))
                return result
        ...
        if (filter_params2['k_eul_avg']) {
            data = data.filter(el => {
                ...
                var result = e.some(r => (filter_params2['k_eul_avg'] >= r - 2) && (filter_params2['k_eul_avg'] <= r+ 2))
                return result
        ...
        <Container fluid style={{overflow:'hidden'}}>
            <Row xs={12}>
                ...
                <Col xs={7} style={{ backgroundColor: '#31393f', 'markerEndmargin': '0'}}>
                    ...
                    <Row style={{ minWidth: "100%", height: '24vh', margin:'0' }}>
